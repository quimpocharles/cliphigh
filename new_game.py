...
"""
    ...
    if tipoff_secs is None:
        ...
        print()
    print("  1. Dry-run Q1 to see estimated timestamps:")
    print("     python3 vod_replay.py --dry-run --quarters 1")
    print()
    print("  2. Calibrate — verify timestamps interactively:")
    print("     python3 vod_replay.py --calibrate --quarters 1")
    print()
    print("  3. Generate Q1 highlights (downloads VOD on first run):")
    print("     python3 vod_replay.py --quarters 1")
    print()
